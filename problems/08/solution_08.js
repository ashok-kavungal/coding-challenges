...
console.info('Old school method: Result is: '+ fib_old_result +' ,Execution time: %dms',exec_time);

let start1 = new Date();
const fib_memo_result = fib_memo(fib_input);
let exec_time1 = new Date() - start1;
console.info('Memoization method: Result is: '+ fib_memo_result +' ,Execution time: %dms',exec_time1);

let start2 = new Date();
const fib_tab_result = fib_tab(fib_input);
let exec_time2 = new Date() - start2;
console.info('Tabulation method: Result is: '+ fib_tab_result +' ,Execution time: %dms',exec_time2);
